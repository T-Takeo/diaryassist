...
<div id="tabs-1">
	...
	<form class="form_diary">
		...
		<div class="form_item">
			...
			<li class="input_list">
			<input type="number" name="low_temperature_input" id="low_temperature_input" value="{$arr_today_diary['low_temperature']}" max="50" /> -
			<input type="number" name="high_temperature_input" id="high_temperature_input" value="{$arr_today_diary['high_temperature']}" max="50" />
			</li>
			</ul>
		</div>
		<div class="form_item">
			...
			<li class="input_list"><input type="number" name="working_hour_input" id="working_hour_input" value="{$arr_today_diary['working_hour']}" max="24" /></li>
			</ul>
		</div>
		<div class="form_item">
			<ul>
			<li><label for="water_minutes_input">灌水時間（単位：分）</label></li>
			<li class="input_list"><input type="number" name="water_minutes_input" id="water_minutes_input" value="{$arr_today_diary['water_minutes']}" /></li>
			</ul>
		</div>
		<div class="form_item">
			<ul>
			<li><label for="yield_input">収穫量（単位：{$arr_item[0]["unit_name"]}）</label></li>
			<li class="input_list"><input type="number" name="yield_input" id="yield_input" value="{$arr_today_diary['yield']}" /></li>
			</ul>
		</div>
		<div class="form_item">
			<ul>
		...
		<div class="form_item">
			<ul>
			<li>label</li>
			<li class="input_list"><textarea name="annotation_input" id="annotation_input">{$arr_today_diary['annotation']}</textarea></li>
			</ul>
		</div>
