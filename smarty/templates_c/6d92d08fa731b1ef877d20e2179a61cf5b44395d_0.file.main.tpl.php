<?php
/* Smarty version 3.1.32, created on 2018-09-13 21:22:47
  from 'C:\pleiades\xampp\htdocs\diaryassist2\smarty\templates\main.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5b9a5697a965c2_80041337',
...
function content_5b9a5697a965c2_80041337 (Smarty_Internal_Template $_smarty_tpl) {
...
）</h3>
		...
		<div class="form_item">
			...
			<li class="input_list">
			<input type="number" name="low_temperature_input" id="low_temperature_input" value="<?php echo $_smarty_tpl->tpl_vars['arr_today_diary']->value['low_temperature'];?>
" max="50" /> -
			<input type="number" name="high_temperature_input" id="high_temperature_input" value="<?php echo $_smarty_tpl->tpl_vars['arr_today_diary']->value['high_temperature'];?>
" max="50" />
			</li>
			</ul>
		</div>
		<div class="form_item">
			...
			<li class="input_list"><input type="number" name="working_hour_input" id="working_hour_input" value="<?php echo $_smarty_tpl->tpl_vars['arr_today_diary']->value['working_hour'];?>
" max="24" /></li>
			</ul>
		</div>
		<div class="form_item">
			...
			<li class="input_list"><input type="number" name="water_minutes_input" id="water_minutes_input" value="<?php echo $_smarty_tpl->tpl_vars['arr_today_diary']->value['water_minutes'];?>
" /></li>
			</ul>
		</div>
		<div class="form_item">
...
）</label></li>
			<li class="input_list"><input type="number" name="yield_input" id="yield_input" value="<?php echo $_smarty_tpl->tpl_vars['arr_today_diary']->value['yield'];?>
" /></li>
			</ul>
		</div>
		<div class="form_item">
		...
		<div class="form_item">
			<ul>
			<li>label</li>
			<li class="input_list"><textarea name="annotation_input" id="annotation_input"><?php echo $_smarty_tpl->tpl_vars['arr_today_diary']->value['annotation'];?>
</textarea></li>
			</ul>
		</div>
